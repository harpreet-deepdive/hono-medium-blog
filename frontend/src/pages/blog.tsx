...
const Blog = () => {
  ...
  return (
    <>
      <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 dark:text-white bg-white dark:bg-gray-900 antialiased">
      ...
      >
        <div className="px-4 mx-auto dark:text-white max-w-screen-xl">
    ...
    <>
      <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
        <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <article className="mx-auto w-[95%] max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            <header className="mb-4 lg:mb-6 not-format">
              <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">
                <div className="h-2.5 bg-gray-200 w-[calc(80%)] rounded-full dark:bg-gray-700 w-48 mb-4"></div>
                <div className="h-2.5 bg-gray-200 w-[calc(70%)] rounded-full dark:bg-gray-700 w-48 mb-4"></div>
              </h1>
              <address className="flex items-center mb-6 not-italic">
                <div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                  <div
